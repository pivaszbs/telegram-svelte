...
<nav class="menu">
	<nav on:click={() => (active = !active)} type="checkbox" id="menu__checkbox" class="menu__checkbox">
		...
		{#if active}
			<Popup active={active} class="menu-list">
	...
	<div class="menu__search-wrapper">
		<input type="search" id="search" class="menu__search" placeholder="Search" autocomplete="off">
		...
		<div class="menu__search_overlay hide">
