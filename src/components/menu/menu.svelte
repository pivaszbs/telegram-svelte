...
<nav class="menu">
	<nav on:click={popupHandler} type="checkbox" id="menu__checkbox" class="menu__checkbox">
	...
	<div class="menu__search-wrapper">
		<input on:blur={unfocusHandler} on:focus={focusHandler} type="search" id="search" class="menu__search" placeholder="Search" autocomplete="off">
